...
int main(int argc, char *argv[])
{
	...
	GLFWwindow *window = glfwCreateWindow(width, height, "libshadertoy example 30-compute", nullptr, nullptr);
	...
	else
	{
		...
		try
		{
			...
			compute_buffer->source_file(ST_BASE_DIR "/shaders/shader-compute.glsl");
			...
			imageBuffer->source_file(ST_BASE_DIR "/shaders/shader-compute-out.glsl");

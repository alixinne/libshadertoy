...
program_resource::program_resource(const gl::program &program, GLenum program_interface, GLuint resource_index)
...
uniform_location uniform_resource::get_location(const gl::program &program) const
{
	return uniform_location(program, location);
}

uniform_resource::uniform_resource(const gl::program &program, GLuint resource_index)
: program_resource(program, INTERFACE_TYPE, resource_index)
{
}

input_resource::input_resource(const gl::program &program, GLuint resource_index)
: program_resource(program, INTERFACE_TYPE, resource_index)
{
}

output_resource::output_resource(const gl::program &program, GLuint resource_index)
: program_resource(program, INTERFACE_TYPE, resource_index)
{
}

program_interface::program_interface(const gl::program &program)
	: program_(program),
	uniforms_(program_),
	inputs_(program_),
	outputs_(program_)

...
void texture::buffer(GLenum internalformat, const gx::buffer &buffer) const
{
	gl_call(glTextureBuffer, GLuint(*this), internalformat, GLuint(buffer));
}

void texture::buffer_range(GLenum internalformat, const gx::buffer &buffer, GLintptr offset, GLsizeiptr size) const
{
...
void texture::unbind_image(GLuint unit) const
{

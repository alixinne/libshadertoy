...
#ifndef _SHADERTOY_BACKENDS_GL4_DRAW_STATE_HPP_
#define _SHADERTOY_BACKENDS_GL4_DRAW_STATE_HPP_
...
protected:
	...
	void apply_polygon_mode() const override;
	...
	void apply_memory_barrier() const override;
...
#endif /* _SHADERTOY_BACKENDS_GL4_DRAW_STATE_HPP_ */

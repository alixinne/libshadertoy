#ifndef _SHADERTOY_BACKENDS_WEBGL_CALLER_HPP_
#define _SHADERTOY_BACKENDS_WEBGL_CALLER_HPP_
...
/**
 * @brief Check errors with the current context wrapper
 */
void check_errors();
...
#endif /* _SHADERTOY_BACKENDS_WEBGL_CALLER_HPP_ */

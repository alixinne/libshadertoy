#ifndef _SHADERTOY_BACKENDS_WEBGL_RENDERBUFFER_HPP_
#define _SHADERTOY_BACKENDS_WEBGL_RENDERBUFFER_HPP_
 ...
 */
class stbackend_webgl_EXPORT null_renderbuffer_error : public shadertoy::shadertoy_error
{
	public:
 ...
 */
class stbackend_webgl_EXPORT renderbuffer
: public resource<renderbuffer, multi_allocator<&glGenRenderbuffers, &glDeleteRenderbuffers>, null_renderbuffer_error, gx::renderbuffer>
{
	public:
...
#endif /* _SHADERTOY_BACKENDS_WEBGL_RENDERBUFFER_HPP_ */

 ...
 */
#define DECLARE_UNIFORM(type, name) shadertoy_EXPORT extern const char name ## Name []; typedef ShaderInput<name ## Name, type> name
/**
 * @brief          Helper macro to declare a uniform instance as an array
 */
#define DECLARE_UNIFORM_N(type, name, n) shadertoy_EXPORT extern const char name ## Name []; typedef ShaderInput<name ## Name, type, n> name
#endif

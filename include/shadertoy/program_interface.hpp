...
struct program_resource
{
	 ...
	 */
	program_resource(const gl::program &program, GLenum program_interface, GLuint resource_index);
};
...
struct uniform_resource : public program_resource
{
	...
	/**
	 * @brief Get a gl::uniform_location object for this uniform.
	 *
	 ...
	 */
	gl::uniform_location get_location(const gl::program &program) const;
	 ...
	 * @param resource_index    Index of the target resource in the program interface
	 */
	uniform_resource(const gl::program &program, GLuint resource_index);
};
...
struct input_resource : public program_resource
{
	 ...
	 * @param resource_index    Index of the target resource in the program interface
	 */
	input_resource(const gl::program &program, GLuint resource_index);
};
...
struct output_resource : public program_resource
{
	 ...
	 * @param resource_index    Index of the target resource in the program interface
	 */
	output_resource(const gl::program &program, GLuint resource_index);
};
...
public:
	 ...
	 */
	resource_interface(const gl::program &program)
	{
...
public:
	program_interface(const gl::program &program);
	 ...
	 *
	 * @return An instance of gl::uniform_location corresponding to this
	 * uniform.
	 */
	template<typename TIndex>
	inline gl::uniform_location get_uniform_location(const TIndex &identifier) const
	 ...
	 * returns an instance of gl::uniform_location corresponding to this
	 * uniform.
	 */
	template<typename TIndex>
	inline std::optional<gl::uniform_location> try_get_uniform_location(const TIndex &identifier) const
	{
